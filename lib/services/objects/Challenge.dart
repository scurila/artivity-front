...
class Challenge {
  ...
  final int? timelimit;
  final int? leftTime;
  final String user_created_pseudo;
  ...
  Challenge({
    ...
    required this.user_created_pseudo,
    this.rating = 0,
    required this.answer_count,
    this.typeForFront=" ",
    this.leftTime,
    this.user = const User(id: 0, pseudo: " "),
  ...
  factory Challenge.fromJson(Map<String, dynamic> json) {
    return Challenge(
      ...
      user_created_pseudo : json['challenge']['user_created']['pseudo'],
      user_created_id : json['challenge']['user_created']['id'],
